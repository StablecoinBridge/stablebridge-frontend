...
import { CircleDollarSign, Droplet } from "lucide-react";
...
const TransactionCard = () => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg p-8 w-[450px]">
      {/* USDT Section */}
      <div className="mb-8">
        ...
        <button className="bg-gray-100 hover:bg-gray-200 transition-colors text-gray-700 px-5 py-2 rounded-full text-sm">
          Connect wallet
        </button>
        
        <div className="flex justify-center my-4">
          <div className="bg-gray-100 w-8 h-8 flex items-center justify-center rounded-full text-gray-500">
            ↓
          </div>
        </div>
      </div>
