  ...
  return (
    <div className="min-h-screen bg-dark-bg text-white">
      ...
      <div className="container mx-auto px-6 py-20 flex flex-col items-center justify-center">
        ...
        >
          <a href="/" className="bg-mint text-black font-medium px-6 py-3 rounded-full flex items-center justify-center hover:bg-mint-dark transition-all duration-300 inline-flex">
            Return Home
          </a>
        </motion.div>
      </div>
